    ...
    public partial class InitialCleanSlate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WeddingTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingTasks", x => x.WeddingTaskId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingUsers", x => new { x.UserId, x.WeddingId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeddingUsers_WeddingId",
                table: "WeddingUsers",
                column: "WeddingId");
        }
